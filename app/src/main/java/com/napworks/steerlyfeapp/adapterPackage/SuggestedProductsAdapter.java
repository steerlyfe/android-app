...
public class SuggestedProductsAdapter extends RecyclerView.Adapter<SuggestedProductsAdapter.MyViewHolder> {
    ...
    public SuggestedProductsAdapter(List<ProductDetailModel> suggestedProductList, Activity activity, int screenWidth) {
