...
//                    Log.d(TAG, "Frame processing thread interrupted on release.");
            ...
            if (mCamera != null) {
                ...
                try {
                    ...
                    CommonMethods.showLog(TAG, "Failed to clear camera preview: " + e);
                }
                mCamera.release();
                mCamera = null;
            }
...
//                Log.w(TAG, "Zoom is not supported on this device");
    ...
    private Camera createCamera() {
        ...
        CommonMethods.showLog(TAG, "WIDTH : " + mRequestedPreviewWidth + " HEIGHT : " + mRequestedPreviewHeight);
        SizePair sizePair = selectSizePair(camera, mRequestedPreviewWidth, mRequestedPreviewHeight);
        if (sizePair == null) {
            throw new RuntimeException("Could not find suitable preview size.");
        }
        Size pictureSize = sizePair.pictureSize();
        CommonMethods.showLog(TAG, "WIDTH : " + sizePair.previewSize().getWidth() + " HEIGHT : " + sizePair.previewSize().getHeight());
        ...
        if (mFocusMode != null) {
            if (parameters.getSupportedFocusModes().contains(
                ...
                CommonMethods.showLog(TAG, "Camera focus mode: " + mFocusMode + " is not supported on this device.");
            }
        }
        ...
        if (mFlashMode != null) {
            if (parameters.getSupportedFlashModes() != null) {
                if (parameters.getSupportedFlashModes().contains(
                    ...
                    CommonMethods.showLog(TAG, "Camera flash mode: " + mFlashMode + " is not supported on this device.");
                }
            }
        }
...
//        CommonMethods.showLog(TAG, "DESIRED WIDTH : " + desiredWidth + " DESIRED HEIGHT : " + desiredWidth);
        for (SizePair sizePair : validPreviewSizes) {
            Size size = sizePair.previewSize();
//            CommonMethods.showLog(TAG, "SIZE WIDTH : " + size.getWidth() + " SIZE HEIGHT : " + size.getHeight());
            int diff = Math.abs(size.getWidth() - desiredWidth) +
                    Math.abs(size.getHeight() - desiredHeight);
//            CommonMethods.showLog(TAG, "DIFF : " + diff);
//            CommonMethods.showLog(TAG, "MIN DIFF LOOP : " + minDiff);
            if (diff < minDiff) {
    ...
    private void setRotation(Camera camera, Camera.Parameters parameters, int cameraId) {
        ...
        switch (rotation) {
            ...
            case Surface.ROTATION_270:
                ...
                break;
            default:
                CommonMethods.showLog(TAG, "Bad rotation value: " + rotation);
        }
...
//                            Log.d(TAG, "Frame processing loop terminated.", e);
                ...
                try {
                    ...
                    CommonMethods.showLog(TAG, "Exception thrown from receiver." + t);
                } finally {
